...
function focusPlusContext(data) {
    ...
    //fTime = pTime(data.features);

    /**
     * Task 2 - Define scales and axes for scatterplot
     */
     var xScale = d3.scaleTime().range([0, width]).domain([minMag,maxMag]);
    ...
    */
     ...
     */
    var pointss = new Points();
    pointss.plot(selected_dots);
    //<---------------------------------------------------------------------------------------------------->
